...
# ACSM_KOKKOS_COMPILATION makes libMesh's device-capable headers (libmesh_device.h, kokkos_*.h)
# expand LIBMESH_DEVICE_INLINE to KOKKOS_INLINE_FUNCTION
KOKKOS_CXXFLAGS += -DMOOSE_KOKKOS_SCOPE=1 -DMETAPHYSICL_KOKKOS_COMPILATION=1 -DACSM_KOKKOS_COMPILATION=1 -fPIC
