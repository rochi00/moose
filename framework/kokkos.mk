...
ifneq ($(PETSC_HAVE_CUDA),)
  ...
  KOKKOS_CPPFLAGS    = $(subst -Werror,-Werror=all-warnings,$(libmesh_CPPFLAGS) $(ADDITIONAL_CPPFLAGS) ${ADDITIONAL_KOKKOS_CPPFLAGS}) -DLIBMESH_KOKKOS_COMPILATION -DMETAPHYSICL_KOKKOS_COMPILATION
  ...
  KOKKOS_CXXFLAGS    =
  KOKKOS_CPPFLAGS    = -DLIBMESH_KOKKOS_COMPILATION -DMETAPHYSICL_KOKKOS_COMPILATION
  KOKKOS_LDFLAGS     =
  ...
  KOKKOS_CPPFLAGS    = $(libmesh_CPPFLAGS) $(ADDITIONAL_CPPFLAGS) ${ADDITIONAL_KOKKOS_CPPFLAGS} -DLIBMESH_KOKKOS_COMPILATION -DMETAPHYSICL_KOKKOS_COMPILATION
  KOKKOS_LDFLAGS     =
