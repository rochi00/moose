# Validation Test 9.1: Laplace Droplet Regression
# Verifies that the alpha-first solve order produces equivalent results
# to the original momentum-first ordering.
#
# Based on laplace_droplet_vof.i
# Success criteria:
#   - Laplace pressure error < 5%
#   - Mass conservation: area_alpha_1 changes < 0.1%
#   - max(|u|) remains small (parasitic currents bounded)
