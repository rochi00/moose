# Minimal 2D PLIC geometric advection test.
# A liquid column (alpha=1 for x<0.3) is advected rightward by a uniform
# velocity field. After 2 timesteps the total liquid volume (integral of
# alpha) must be conserved and the interface must remain sharp.
