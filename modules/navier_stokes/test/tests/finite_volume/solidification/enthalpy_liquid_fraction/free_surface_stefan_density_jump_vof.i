...
T_solid = 0.9
T_liquid = 1.2
solid_liquid_interface_y = 0.2
material_interface_y = 0.7
mu_gas = 1
mu = 1
...
[Functions]
  [initial_alpha]
    type = ParsedFunction
    expression = 'if(y < material_interface_y, 1, 0)'
    symbol_names = 'material_interface_y'
    symbol_values = '${material_interface_y}'
  []
  [initial_fl]
    type = ParsedFunction
    expression = 'if(y < material_interface_y, if(y < solid_liquid_interface_y, 0, 1), 0)'
    symbol_names = 'material_interface_y solid_liquid_interface_y'
    symbol_values = '${material_interface_y} ${solid_liquid_interface_y}'
  []
  [initial_T]
    type = ParsedFunction
    expression = 'if(y < material_interface_y, if(y < solid_liquid_interface_y, T_solid, T_liquid), T_gas)'
    symbol_names = 'material_interface_y solid_liquid_interface_y T_solid T_liquid T_gas'
    symbol_values = '${material_interface_y} ${solid_liquid_interface_y} ${T_solid} ${T_liquid} ${T_gas}'
  []
  [initial_rho_h]
    type = ParsedFunction
    expression = 'if(y < material_interface_y, if(y < solid_liquid_interface_y, rho_solid * cp_solid * T_solid, rho_liquid * cp_liquid * T_liquid), rho_gas * cp_gas * T_gas)'
    symbol_names = 'material_interface_y solid_liquid_interface_y rho_solid rho_liquid rho_gas cp_solid cp_liquid cp_gas T_solid T_liquid T_gas'
    symbol_values = '${material_interface_y} ${solid_liquid_interface_y} ${rho_solid} ${rho_liquid} ${rho_gas} ${cp_solid} ${cp_liquid} ${cp_gas} ${T_solid} ${T_liquid} ${T_gas}'
  []
  [bottom_rho_h]
    type = ParsedFunction
